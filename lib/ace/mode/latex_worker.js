...
var Parse = function (text) {
	...
	console.log("TokenError", fromToken, toToken);
	...
	console.log("result:", result.index, text.substring(pos, result.index));
	...
	if (code === "%") {
		...
		console.log("setting SPECIAL.lastIndex to idx+1", idx+1);
