...
var Mode = function() {
	...
	worker.on("lint", function(results) {
		...
		var start_col = results.data[i].start_col;
		var end_col = results.data[i].end_col;
		...
		if (!savedRange[key]) {
		    ...
		    var range = new Range(new_range.start_row, new_range.start_col, new_range.end_row, new_range.end_col);
		    range.id = session.addMarker(range, "ace_error-marker");
